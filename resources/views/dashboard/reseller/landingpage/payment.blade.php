                ...
                <form action="{{ route('payment.upload') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="order_id" id="order_id" class="form-control" placeholder="Order ID"
                            value="{{ old('order_id', $order_id ?? '') }}" required readonly>
                    </div>

                    <div class="mb-3">
                        <label for="image_bukti_tf" class="form-label">Upload Payment Proof</label>
                        <input type="file" name="image_bukti_tf" id="image_bukti_tf" class="form-control"
                    ...
                    <div class="mb-3">
                        ...
                        <p class="form-control bg-light">
                            {{ isset($total) ? 'Rp ' . number_format($total, 0, ',', '.') : 'Rp 0' }}</p>
                    </div>
